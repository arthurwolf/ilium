//! Typed errors for `illium-server`.
//!
...
use illium_core::{NodeId, TreeError};
...
pub enum ServerError {
    ...
    /// `illium_ipc::ServerEvent::Error`, never propagated up to crash the
...
/// Why `~/.config/illium/config.toml` could not be loaded -- kept separate
