...
pub enum IconTarget {
    ...
    /// The "ask for update" context-menu entry and its project-row shortcut
    /// button -- see `App::ContextMenuAction::AskForUpdate` and
    /// `tree_ui::TreeRowAction::AskForUpdate`.
    AskForUpdate,
    ScreenTransferLeft,
    ScreenTransferRight,
    ScreenTransferUp,
    ...
    AgentToolbarSmartCopy,
    AgentToolbarCopyLastMessage,
    AgentToolbarEffort,
    AgentToolbarModel,
    AgentToolbarClaudeHaiku,
    AgentToolbarClaudeSonnet,
    AgentToolbarClaudeOpus,
    AgentToolbarClaudeFable,
    AgentToolbarExit,
    AgentToolbarFast,
...
impl IconTarget {
    pub const ALL: [Self; 64] = [
        ...
        Self::BackgroundTaskStillRunning,
        ...
        Self::AgentToolbarSmartCopy,
        Self::AgentToolbarCopyLastMessage,
        Self::AgentToolbarEffort,
        Self::AgentToolbarModel,
        Self::AgentToolbarClaudeHaiku,
        Self::AgentToolbarClaudeSonnet,
        Self::AgentToolbarClaudeOpus,
        Self::AgentToolbarClaudeFable,
    ...
    pub const fn label(self) -> &'static str {
        match self {
            ...
            Self::WaitingBackground => "Waiting on subagents",
            Self::BackgroundTaskStillRunning => "Settling: leftover work running",
            Self::WaitingApproval => "Needs approval",
            Self::Done => "Finished, unread",
            Self::Idle => "Idle",
            ...
            Self::Parked => "Parked: waiting on its task",
            Self::TaskPending => "Task: registered, not started",
            Self::TaskDone => "Task: done",
            Self::TaskError => "Task: failed",
            Self::MonitorFailed => "Task: monitor lost it",
            ...
            Self::AgentToolbarSmartCopy => "Agent toolbar: smart copy",
            ...
            Self::AgentToolbarClaudeHaiku => "Claude model: Haiku",
            Self::AgentToolbarClaudeSonnet => "Claude model: Sonnet",
            Self::AgentToolbarClaudeOpus => "Claude model: Opus",
            Self::AgentToolbarClaudeFable => "Claude model: Fable",
    ...
    pub const fn key(self) -> &'static str {
        match self {
            ...
            Self::BackgroundTaskStillRunning => "background_task_still_running",
            ...
            Self::AskForUpdate => "ask_for_update",
            ...
            Self::AgentToolbarSmartCopy => "agent_toolbar_smart_copy",
            ...
            Self::AgentToolbarClaudeHaiku => "agent_toolbar_claude_haiku",
            Self::AgentToolbarClaudeSonnet => "agent_toolbar_claude_sonnet",
            Self::AgentToolbarClaudeOpus => "agent_toolbar_claude_opus",
            Self::AgentToolbarClaudeFable => "agent_toolbar_claude_fable",
    ...
    pub const fn suggestions(self) -> &'static [&'static str] {
        match self {
            ...
            Self::Working => &["⠋", "◌", "◒", "✦"],
            Self::WaitingBackground => &["🕗", "◴", "⌛", "⏳"],
            Self::BackgroundTaskStillRunning => &["🌀", "🔁", "♻️", "🧵"],
            Self::WaitingApproval => &["?", "!", "⚑", "✋"],
            Self::Done => &["🔔", "✓", "●", "✦"],
            Self::Idle => &["●", "·", "○", "—"],
            Self::GoalActive => &["🎯", "🏁", "🚩", "⚑"],
...
pub struct IconSettings {
    ...
    pub background_task_still_running: String,
    ...
    pub agent_toolbar_smart_copy: String,
    pub agent_toolbar_copy_last_message: String,
    pub agent_toolbar_effort: String,
    pub agent_toolbar_model: String,
    pub agent_toolbar_claude_haiku: String,
    pub agent_toolbar_claude_sonnet: String,
    pub agent_toolbar_claude_opus: String,
    pub agent_toolbar_claude_fable: String,
...
impl IconSettings {
    pub fn from_target(mut value: impl FnMut(IconTarget) -> String) -> Self {
        Self {
            ...
            background_task_still_running: value(IconTarget::BackgroundTaskStillRunning),
            ...
            parked: value(IconTarget::Parked),
            task_pending: value(IconTarget::TaskPending),
            task_done: value(IconTarget::TaskDone),
            task_error: value(IconTarget::TaskError),
            monitor_failed: value(IconTarget::MonitorFailed),
            ...
            ask_for_update: value(IconTarget::AskForUpdate),
            ...
            agent_toolbar_smart_copy: value(IconTarget::AgentToolbarSmartCopy),
            ...
            agent_toolbar_claude_haiku: value(IconTarget::AgentToolbarClaudeHaiku),
            agent_toolbar_claude_sonnet: value(IconTarget::AgentToolbarClaudeSonnet),
            agent_toolbar_claude_opus: value(IconTarget::AgentToolbarClaudeOpus),
            agent_toolbar_claude_fable: value(IconTarget::AgentToolbarClaudeFable),
    ...
    pub fn glyph(&self, target: IconTarget) -> &str {
        match target {
            ...
            IconTarget::BackgroundTaskStillRunning => &self.background_task_still_running,
            ...
            IconTarget::Parked => &self.parked,
            IconTarget::TaskPending => &self.task_pending,
            IconTarget::TaskDone => &self.task_done,
            IconTarget::TaskError => &self.task_error,
            IconTarget::MonitorFailed => &self.monitor_failed,
            ...
            IconTarget::AskForUpdate => &self.ask_for_update,
            ...
            IconTarget::AgentToolbarSmartCopy => &self.agent_toolbar_smart_copy,
            ...
            IconTarget::AgentToolbarClaudeHaiku => &self.agent_toolbar_claude_haiku,
            IconTarget::AgentToolbarClaudeSonnet => &self.agent_toolbar_claude_sonnet,
            IconTarget::AgentToolbarClaudeOpus => &self.agent_toolbar_claude_opus,
            IconTarget::AgentToolbarClaudeFable => &self.agent_toolbar_claude_fable,
    ...
    pub fn set(&mut self, target: IconTarget, glyph: String) {
        let slot = match target {
            ...
            IconTarget::BackgroundTaskStillRunning => &mut self.background_task_still_running,
            ...
            IconTarget::Parked => &mut self.parked,
            IconTarget::TaskPending => &mut self.task_pending,
            IconTarget::TaskDone => &mut self.task_done,
            IconTarget::TaskError => &mut self.task_error,
            IconTarget::MonitorFailed => &mut self.monitor_failed,
            ...
            IconTarget::AskForUpdate => &mut self.ask_for_update,
            ...
            IconTarget::AgentToolbarSmartCopy => &mut self.agent_toolbar_smart_copy,
            ...
            IconTarget::AgentToolbarClaudeHaiku => &mut self.agent_toolbar_claude_haiku,
            IconTarget::AgentToolbarClaudeSonnet => &mut self.agent_toolbar_claude_sonnet,
            IconTarget::AgentToolbarClaudeOpus => &mut self.agent_toolbar_claude_opus,
            IconTarget::AgentToolbarClaudeFable => &mut self.agent_toolbar_claude_fable,
